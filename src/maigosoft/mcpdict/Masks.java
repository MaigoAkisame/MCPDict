...
public interface Masks {
    ...
    public static final int MASK_KR             = 0x20;
    public static final int MASK_VN             = 0x40;
    public static final int MASK_JP_GO          = 0x80;
    public static final int MASK_JP_KAN         = 0x100;
    public static final int MASK_JP_TOU         = 0x200;
    public static final int MASK_JP_KWAN        = 0x400;
    public static final int MASK_JP_OTHER       = 0x800;
    ...
    public static final int MASK_FAVORITE       = 0x1000;
}
